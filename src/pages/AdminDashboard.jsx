...
function DelegateModal({
  ...
  return (
    <div className="fixed inset-0 z-[1000] bg-slate-900/40 backdrop-blur-[2px] flex items-stretch justify-center p-2 md:items-center md:p-4">
      <div className="flex w-full max-w-lg max-h-[calc(100dvh-1rem)] md:max-h-[calc(100dvh-2rem)] flex-col bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden">
        ...
        <div className="shrink-0 px-5 py-4 border-t border-slate-200 flex justify-end">
          <button
            onClick={onClose}
